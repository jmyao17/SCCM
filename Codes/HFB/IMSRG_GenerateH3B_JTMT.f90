!          ..........................................................
!          ME3B->ME2B: 1/3* <(12a)J;TMT | V | (34b)J;TMT>*rho_ab
!          ..........................................................
!          - Read the two-body interaction:
!            V'_12,34 = V_12,34 + W_123,456*rho_36
!          - Extract the second term
!            by using V'_12,34 - V_12,34
!          ..........................................................
           subroutine V3B2V2B_JTMT()
           USE VAPHFB_PAR
           implicit none
       ...
       print *,'.... computing the effective ME2B from ME3B ..'
!     .............. initialization
...
! 5: pppp
      ...
      enddo
       ...
       if(Input%cValID == 'emax04') File%f3bJ = '../Int/chi2b3bA48_srg0625_notpp_emax04_hwHO20_J.dat'
       if(Input%cValID == 'emax06') File%f3bJ = '../Int/chi2b3bA48_srg0625_notpp_emax06_hwHO20_J.dat'
       endif

        write(*,*) '    Read ME2B3B from ',File%f3bJ
        open(26,file=File%f3bJ,status='old')
!      .............................
...
!    ......................................
!    read the two-body matrix elements only
!    ......................................

        write(*,*) '    Read ME2B again from ',File%f2bJ
        open(26,file=File%f2bJ,status='old')
!      .............................
6      read(26,*,end=7) t1,t2,t3,t4,n1,n2,n3,n4,lj1,lj2,lj3,lj4,JJ,me
       nlj1 = SPB%nlj(n1,lj1)   ! n1 =0, 1, 2  
       nlj2 = SPB%nlj(n2,lj2) 
       nlj3 = SPB%nlj(n3,lj3) 
       nlj4 = SPB%nlj(n4,lj4)
...
!      ................ print
        write(*,*) '    Print ME2B to ',File%f3b22bJTMT
        open(46,file=File%f3b22bJTMT,status='unknown')
       do ia=1,HO%nljmax
       do ib=ia,HO%nljmax
                     d_ab = zero
...
!            if(ia.eq.1 .and. ib.eq.2 .and. ic.eq.1 .and. id.eq.4)
            if(abs(VJTA) .gt. CHOP)  &
     &      write(46,'(7i5,f15.8)') ia,ib,ic,id,iJ,iT,MMT,VJTA
