          subroutine Separate_np(ndim)
!  ..............................................
!  applicable only to the case without np mixing 
!  ..............................................
          use vaphfb_par
          implicit none

          integer itconv,ndim,mitf,it,icc(0:1),ik,il,itk
          real*8 vv1(ndim,0:1),vv2(ndim,0:1),vvk

!      it = 0 for n;  1 for proton
!      itk= 1 for n; -1 for proton 
          icc(0:1) = 0
          do ik=1,ndim
             itk = itconv(HFB%it1(ik))
             vvk = HFB%vv1(ik)
             icc(mitf(itk)) = icc(mitf(itk)) + 1
             vv1(icc(mitf(itk)),mitf(itk)) = vvk

                write(*,*) mitf(itk),icc(mitf(itk)),vvk
          enddo
          write(*,*) ' ................'
          do it=0,1   ! n,p
             do ik=1,icc(it)
                write(*,*) it,ik,vv1(ik,it)
          enddo
          enddo
         end
...
!      parameter (ntest=10)
      ...
      data UPLO/'U'/,MTHD/'P'/
!     ............................................................. initialization
       write(*,*) ' Separate neutron from proton ...'
       call Separate_np(npz2)
