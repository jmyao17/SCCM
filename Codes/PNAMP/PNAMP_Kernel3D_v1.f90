...
!     ................................................
      ...
      !integration over all the rotation Euler angles
...
!      ................ integration over angles
      ...
      do J2=0,JJmax,2    
         ! angular momentum of initial state
         Ji = J2
...
!           angular momentum projected quantities 
            do kk=1,NOBS
               ZsumJKK(kk,K1,K2)=Zzero
            end do

                ! *******************************************  
                ! ZRES: <JNZ,K1,q1| O_L |JNZ,K2,q2(alp,bet,gam)> 
                ! *******************************************  
                ...
                ! ZRES: <JNZ,q1| O_2 |JNZ,q2(alp,bet,gam)> 
