...
!        symmetry
        ...
        print *,AMP%NLEG_ALP,NLEG_BET_Max,AMP%NLEG_GAM
...
!        ........ Onishi formula works
        ! if(PNP%NFOM .eq.1) then
         call Onishi(ZU0,ZV0,ZU1bar,ZV1bar,znorm,HO%NLEV) ! not valid
        ! for cranking states
...
!  (2)
          ...
          call HFB_Energy_COMPLEX(zro,zkapa10,zkapa01,H%zME1BM,zEkin,zEHFB,NLEV,.true.)
