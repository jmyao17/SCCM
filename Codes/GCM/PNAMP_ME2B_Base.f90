...
!     ............................. Full space for SPB
      ...
      if(lpr) write(*,*) 'Construct TPB in Full Space ...'  
...
!              if(J.eq.9 .and. PP.eq.0 .and. tt.eq.0) print *, bb
            enddo
            enddo
          enddo ! J
          enddo ! J2
