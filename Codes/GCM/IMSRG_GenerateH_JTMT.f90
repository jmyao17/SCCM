...
! 5: pppp
      ...
      enddo
       ...
       open(26,file='../Int/IMSRG_'//Input%cFlow//'_'//Input%cIntID//'_J.dat',status='old')
!      .................... 0(n); 1 (p)
...
!         if(t1 .ne. t2 .or. nlj1 .ne. nlj2 .or. t3 .ne. t4 .or. nlj3 .ne. nlj4)  &
     ...
     & = V_AB_CD_J(nlj1,nlj2,nlj3,nlj4,JJ,it1234(t1,t2,t3,t4))*iphase_12*iphase_34 
             ...
             if(JJ.eq.0 .and. nlj1.eq.1 .and.nlj2.eq.1 .and. nlj3.eq.1 .and. nlj4.eq.1 ) &
...
!      ................ print
       open(36,file='../Int/IMSRG_'//Input%cFlow//'_'//Input%cIntID &
     &     //'_JTMT.dat', &
     &     status='unknown')
       do ia=1,HO%nljmax
       do ib=ia,HO%nljmax
