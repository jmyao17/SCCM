...
!         write(*,*) real(ZU(jj,ii)), real(ZV(jj,ii)) 
       end do
      end do
      !LU factorization
...
!         write(*,*) ii,ZWR(ii)
       ...
       ztest = ztest + log(1+ZWR(ii))
      end do
!      write(*,*) 'ztestlog10()=',ztest
      Det  = dreal(EXP(-ztest/4))
...
!     ................... scaled with lambda=0.01
      ZPfaf = ZPfaf * Input%Cscale !*0.01     
