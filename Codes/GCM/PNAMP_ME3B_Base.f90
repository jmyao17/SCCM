...
!    n=0,1,2,3,...
!    ************************************************
           subroutine Rho3B_1B_Model_Space()
!    ...................................................
!    One-body basis
!    ...................................................
           USE VAPHFB_PAR
...
!        ........................ read model (valence) space
           ...
           NOrbit(1) = 0
!        ........................ read model (valence) space
           open(31,file="../Int/me3b_"//trim(Input%vs4me3b)//".val",status="old")
           read(31,*)
           read(31,*) tnlj_vmax
...
!    ************************************************
           subroutine Rho3B_2B_Model_Space()
!    ...................................................
!    One-body basis
!    ...................................................
           USE VAPHFB_PAR
     ...
     &  ALLOCATE(Rho3B%VTPB%a(0:bMax,1:Rho3B%VSPB%tnlj_vmax,1:Rho3B%VSPB%tnlj_vmax))
        ...
        do tnlj=1, Rho3B%VSPB%tnlj_vmax  ! 8
            ...
            do twom = -twoj,twoj,2  ! doubled  
               ...
               write(*,'(6i4)') tnljm_dmax,t,n,l,twoj,twom
...
!    ------------------------------ b=0,...,; a=1,2.., 
            ...
            write(401,'(4i5)') JJ,PP,tt,Rho3B%VTPB%block(JJ,PP,tt)
          enddo
          enddo
      enddo
      enddo
...
!-----------------------------
      ...
      do JJ=0,JMax_tp(tt,PP)
         ...
         write(200,10) bc, tt, PP, JJ,  Rho3B%VTPB%aMax(bb)  ! bc=0,1,2,.. 
         write(*,'(5i5)') tt,PP,JJ,bb,Rho3B%VTPB%aMax(bb) !,tnlj_1,tnlj_2,pTPB%a(bb,tnlj_1,tnlj_2)
...
!-------------------------------------------------------
       ...
       write(*,*) '----------------------------------------------------'
       write(*,'(a,i6,a,i6,a)') ' Dimension of Rho3B in m-scheme:',d123
       write(*,*) '----------------------------------------------------'
...
!     &             stop 'Error: dMaxMax should be larger!'
                   ...
                   write(400,'(a,5i5,a,i8)') 'Rho3B%idx(',bm,bb,a12,a3,J123,')=',d123
                enddo ! J123   
!-------------------------------------------------------
             enddo ! a12
       enddo ! tt
