...
!      ........ quadrupole deformation parameter
        call Q_0(cME1B%Q40t,ro_0,Q40p,Q40n,NLEV)
         write(ie,'(A20,3F15.6)') 'Q40',Q40p,Q40n,Q40p+Q40n
...
!      ........ deformation parameter
     ...
     &  dabs(Q_T1m1_J00),dabs(Q_T10_J00),dabs(Q_T1p1_J00)
        ...
        Rch=dsqrt(r2p/Input%nprot+0.64)
        write(900+rank,'(f10.6,4f7.3,3f9.3,3f9.3,3f10.3)') epsi,shared%cf,beta20n,beta20p,beta20t, &
     &  gam2n,gam2p,gam2t,dabs(Q_T00_J10),EPa_NN,EPa_PP,EPa_PN+EPa_NP,Etot,Rch
