      ...
      subroutine spectrum(jmn,jmx,jdf)
!..............................................................................
...
!................................................. 
         call mean_variance(ji,li,var1,var2)
         GCM%mean(ji,li)     = var1
         GCM%variance(ji,li) = var2
        enddo !li     
   89 enddo ! ji
...
!          write(*,*) 'ftest=',ftest 
     ...
     &              GCM%mean(ji,li),GCM%variance(ji,li)
        enddo !li    
   99 enddo ! ji
!
      print 102
      ...
      subroutine spectrum_general(jmn,jmx,jdf)
!..............................................................................
!     calculate spectroscopic quadupole moment                                . 
!..............................................................................
      USE VAPHFB_Par 
